 ...
 * Submit Form
 *
 * @package     AutomatorWP\Integrations\WS_Form\Triggers\Submit_Form
...
class AutomatorWP_WS_Form_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'ws_form';
    public $trigger = 'ws_form_submit_form';
...
new AutomatorWP_WS_Form_Submit_Form();