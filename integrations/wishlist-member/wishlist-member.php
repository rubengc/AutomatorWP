...
final class AutomatorWP_WishList_Member_Integration {

    /**
     * @var         AutomatorWP_WishList_Member_Integration $instance The one true AutomatorWP_WishList_Member_Integration
     * @since       1.0.0
     */
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_WishList_Member_Integration self::$instance The one true AutomatorWP_WishList_Member_Integration
     */
    public static function instance() {
        if( !self::$instance ) {
            self::$instance = new AutomatorWP_WishList_Member_Integration();
...
/**
 * The main function responsible for returning the one true AutomatorWP_WishList_Member_Integration instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_WishList_Member_Integration The one true AutomatorWP_WishList_Member_Integration
 */
function AutomatorWP_WishList_Member_Integration() {
    return AutomatorWP_WishList_Member_Integration::instance();
}
add_action( 'automatorwp_pre_init', 'AutomatorWP_WishList_Member_Integration' );
