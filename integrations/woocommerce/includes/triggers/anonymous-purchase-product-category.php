...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Category extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product of a category', 'automatorwp' ),
            'select_option'     => __( 'Guest purchases a product of <strong>a category</strong>', 'automatorwp' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest purchases a product of %1$s %2$s time(s)', 'automatorwp' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'Guest purchases a product of %1$s', 'automatorwp' ), '{term}' ),
