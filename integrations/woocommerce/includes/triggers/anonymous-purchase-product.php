...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product', 'automatorwp' ),
            'select_option'     => __( 'Guest purchases <strong>a product</strong>', 'automatorwp' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest purchases %1$s %2$s time(s)', 'automatorwp' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest purchases %1$s', 'automatorwp' ), '{post}' ),
