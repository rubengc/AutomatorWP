...
class AutomatorWP_WooCommerce_Purchase_Subscription extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases subscription of a product', 'automatorwp' ),
            'select_option'     => __( 'User <strong>purchases</strong> subscription of a product', 'automatorwp' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases subscription of %1$s %2$s time(s)', 'automatorwp' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User purchases subscription of %1$s', 'automatorwp' ), '{post}' ),
