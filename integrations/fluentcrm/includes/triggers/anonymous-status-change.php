 ...
 *
 * @package     AutomatorWP\Integrations\FluentCRM\Triggers\Anonymous_Status_Change
...
class AutomatorWP_FluentCRM_Anonymous_Status_Change extends AutomatorWP_Integration_Trigger {

    public $integration = 'fluentcrm';
    public $trigger = 'fluentcrm_anonymous_status_change';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Contact status changes to a status', 'automatorwp' ),
            'select_option'     => __( 'Contact status changes to <strong>a status</strong>', 'automatorwp' ),
            /* translators: %1$s: List. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Contact status changes to %1$s %2$s time(s)', 'automatorwp' ), '{status}', '{times}' ),
            /* translators: %1$s: List. */
            'log_label'         => sprintf( __( 'Contact status changes to %1$s', 'automatorwp' ), '{status}' ),
            'action'            => array(
...
new AutomatorWP_FluentCRM_Anonymous_Status_Change();