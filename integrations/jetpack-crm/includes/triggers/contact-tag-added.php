 ...
 * Contact Tag Added
 *
 * @package     AutomatorWP\Integrations\Jetpack_CRM\Triggers\Contact_Tag_Added
...
class AutomatorWP_Jetpack_CRM_Contact_Tag_Added extends AutomatorWP_Integration_Trigger {

    public $integration = 'jetpack_crm';
    public $trigger = 'jetpack_crm_contact_tag_added';
...
new AutomatorWP_Jetpack_CRM_Contact_Tag_Added();