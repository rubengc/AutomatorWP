 ...
 * Free Membership
 *
 * @package     AutomatorWP\Integrations\Restrict_Content_Pro\Triggers\Free_Membership
...
class AutomatorWP_Restrict_Content_Pro_Free_Membership extends AutomatorWP_Integration_Trigger {

    public $integration = 'restrict_content_pro';
    public $trigger = 'restrict_content_pro_free_membership';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User gets a free membership level', 'automatorwp' ),
            'select_option'     => __( 'User gets <strong>a free membership level</strong>', 'automatorwp' ),
            /* translators: %1$s: Content title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User gets %1$s %2$s time(s)', 'automatorwp' ), '{membership}', '{times}' ),
            /* translators: %1$s: Content title. */
            'log_label'         => sprintf( __( 'User gets %1$s', 'automatorwp' ), '{membership}' ),
            ...
            'options'           => array(
                'membership' => automatorwp_utilities_ajax_selector_option( array(
                    ...
                    'option_none_label' => __( 'any free membership level', 'automatorwp' ),
...
new AutomatorWP_Restrict_Content_Pro_Free_Membership();