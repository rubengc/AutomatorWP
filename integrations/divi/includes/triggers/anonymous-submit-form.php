 ...
 *
 * @package     AutomatorWP\Integrations\Divi\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Divi_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'divi';
    public $trigger = 'divi_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp' ), '{form_id}' ),
            /* translators: %1$s: Form name. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp' ), '{form_id}' ),
...
new AutomatorWP_Divi_Anonymous_Submit_Form();