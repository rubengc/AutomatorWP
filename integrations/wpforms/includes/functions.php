 ...
 * @return array
 */
function automatorwp_wpforms_get_form_fields_values( $fields ) {
 ...
 * @return string
 */
function automatorwp_wpforms_parse_automation_tags( $parsed_content, $replacements, $automation_id, $user_id, $content ) {
    ...
    foreach( $triggers as $trigger ) {
        ...
        if( $trigger_args['integration'] !== 'wpforms' ) {
            continue;
        }
...
add_filter( 'automatorwp_parse_automation_tags', 'automatorwp_wpforms_parse_automation_tags', 10, 5 );