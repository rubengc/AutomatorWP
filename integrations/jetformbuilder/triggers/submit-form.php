 ...
 * Submit Form
 *
 * @package     AutomatorWP\Integrations\JetFormBuilder\Triggers\Submit_Form
...
class AutomatorWP_JetFormBuilder_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'jetformbuilder';
    public $trigger = 'jetformbuilder_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User submits a form', 'automatorwp-jetformbuilder' ),
            'select_option'     => __( 'User submits <strong>a form</strong>', 'automatorwp-jetformbuilder' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User submits %1$s %2$s time(s)', 'automatorwp-jetformbuilder' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User submits %1$s', 'automatorwp-jetformbuilder' ), '{post}' ),
...
new AutomatorWP_JetFormBuilder_Submit_Form();