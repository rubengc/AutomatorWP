 ...
 *
 * @package     AutomatorWP\Integrations\Gravity_Forms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Gravity_Forms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'gravity_forms';
    public $trigger = 'gravity_forms_anonymous_submit_form';
...
new AutomatorWP_Gravity_Forms_Anonymous_Submit_Form();