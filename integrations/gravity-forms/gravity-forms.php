...
final class AutomatorWP_Gravity_Forms_Integration {

    /**
     * @var         AutomatorWP_Gravity_Forms_Integration $instance The one true AutomatorWP_Gravity_Forms_Integration
     * @since       1.0.0
     */
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_Gravity_Forms_Integration self::$instance The one true AutomatorWP_Gravity_Forms_Integration
     */
    public static function instance() {
        if( !self::$instance ) {
            self::$instance = new AutomatorWP_Gravity_Forms_Integration();
...
/**
 * The main function responsible for returning the one true AutomatorWP_Gravity_Forms_Integration instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_Gravity_Forms_Integration The one true AutomatorWP_Gravity_Forms_Integration
 */
function AutomatorWP_Gravity_Forms_Integration() {
    return AutomatorWP_Gravity_Forms_Integration::instance();
}
add_action( 'automatorwp_pre_init', 'AutomatorWP_Gravity_Forms_Integration' );
