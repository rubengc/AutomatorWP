 ...
 * User Subscribe
 *
 * @package     AutomatorWP\Integrations\Mailchimp\Actions\User_Subscribe
...
class AutomatorWP_Mailchimp_User_Subscribe extends AutomatorWP_Integration_Action {

    public $integration = 'mailchimp';
    public $action = 'mailchimp_user_subscribe';
...
new AutomatorWP_Mailchimp_User_Subscribe();