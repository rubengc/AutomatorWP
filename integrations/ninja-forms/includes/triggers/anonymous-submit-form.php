 ...
 *
 * @package     AutomatorWP\Integrations\Ninja_Forms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Ninja_Forms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'ninja_forms';
    public $trigger = 'ninja_forms_anonymous_submit_form';
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'options'           => array(
                'post' => automatorwp_utilities_ajax_selector_option( array(
                    ...
                    'action_cb'         => 'automatorwp_ninja_forms_get_forms',
                    'options_cb'        => 'automatorwp_ninja_forms_options_cb_form',
                    'default'           => 'any'
                ) ),
    ...
    public function listener( $data ) {
        ...
        $form_fields = automatorwp_ninja_forms_get_form_fields_values( $data );
...
new AutomatorWP_Ninja_Forms_Anonymous_Submit_Form();