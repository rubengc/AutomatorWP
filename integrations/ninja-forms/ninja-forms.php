...
final class AutomatorWP_Ninja_Forms_Integration {

    /**
     * @var         AutomatorWP_Ninja_Forms_Integration $instance The one true AutomatorWP_Ninja_Forms_Integration
     * @since       1.0.0
     */
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_Ninja_Forms_Integration self::$instance The one true AutomatorWP_Ninja_Forms_Integration
     */
    public static function instance() {
        if( !self::$instance ) {
            self::$instance = new AutomatorWP_Ninja_Forms_Integration();
...
/**
 * The main function responsible for returning the one true AutomatorWP_Ninja_Forms_Integration instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_Ninja_Forms_Integration The one true AutomatorWP_Ninja_Forms_Integration
 */
