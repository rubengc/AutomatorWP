...
final class AutomatorWP_Easy_Digital_Downloads_Integration {

    /**
     * @var         AutomatorWP_Easy_Digital_Downloads_Integration $instance The one true AutomatorWP_Easy_Digital_Downloads_Integration
     * @since       1.0.0
     */
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_Easy_Digital_Downloads_Integration self::$instance The one true AutomatorWP_Easy_Digital_Downloads_Integration
     */
    public static function instance() {
        if( !self::$instance ) {
            self::$instance = new AutomatorWP_Easy_Digital_Downloads_Integration();
...
/**
 * The main function responsible for returning the one true AutomatorWP_Easy_Digital_Downloads_Integration instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_Easy_Digital_Downloads_Integration The one true AutomatorWP_Easy_Digital_Downloads_Integration
 */
