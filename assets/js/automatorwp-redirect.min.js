...
automatorwp_redirect_in_progress=!0;$.ajax({url:automatorwp_redirect.ajaxurl,method:'POST',data:{action:'automatorwp_check_for_redirect',nonce:automatorwp_redirect.nonce,user_id:automatorwp_redirect.user_id,},success:function(response){if(response.data===undefined&&response.data.redirect_url===undefined){automatorwp_redirect_in_progress=!1;return}
if(!automatorwp_redirect_to_url(response.data.redirect_url)){automatorwp_redirect_in_progress=!1}},error:function(response){if(response.data===undefined&&response.data.redirect_url===undefined){automatorwp_redirect_in_progress=!1;return}
...
var excluded_url=!1;automatorwp_redirect.excluded_urls.forEach(function(to_match){if(url!==undefined&&url.includes(to_match)){excluded_url=!0}});if(excluded_url){return!0}
...
if(url!==undefined&&url.includes('admin-ajax.php')){var excluded_action=!1;automatorwp_redirect.excluded_ajax_actions.forEach(function(to_match){if(data!==undefined&&data.includes('action='+to_match)){excluded_action=!0}});if(excluded_action){return!0}}
