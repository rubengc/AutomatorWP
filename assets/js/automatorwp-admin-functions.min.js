...
var post_types=$this.data('post-type').split(',');var select2_args={ajax:{url:ajaxurl,dataType:'json',delay:250,type:'POST',data:function(params){return{q:params.term,page:params.page||1,action:'automatorwp_get_posts',nonce:automatorwp_admin_functions.nonce,post_type:post_types,option_none:$this.data('option-none'),option_none_value:$this.data('option-none-value'),option_none_label:$this.data('option-none-label'),}},processResults:automatorwp_select2_posts_process_results},escapeMarkup:function(markup){return markup},templateResult:(post_types.length===1?automatorwp_select2_posts_template_result:automatorwp_select2_post_types_template_result),theme:'default automatorwp-select2',placeholder:($this.data('placeholder')?$this.data('placeholder'):automatorwp_admin_functions.post_selector_placeholder),allowClear:!0,multiple:($this[0].hasAttribute('multiple'))};$this.automatorwp_select2(select2_args)}
