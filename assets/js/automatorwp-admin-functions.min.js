...
var select2_args={ajax:{url:ajaxurl,dataType:'json',delay:250,type:'POST',data:function(params){return{q:params.term,page:params.page||1,action:'automatorwp_get_objects',nonce:automatorwp_admin_functions.nonce,table:$this.data('table'),option_none:$this.data('option-none'),option_none_value:$this.data('option-none-value'),option_none_label:$this.data('option-none-label'),}},processResults:automatorwp_select2_objects_process_results},escapeMarkup:function(markup){return markup},templateResult:automatorwp_select2_objects_template_result,theme:'default automatorwp-select2',placeholder:($this.data('placeholder')?$this.data('placeholder'):automatorwp_admin_functions.object_selector_placeholder),allowClear:!0,multiple:($this[0].hasAttribute('multiple'))};$this.automatorwp_select2(select2_args)}
function automatorwp_ajax_selector($this){if($this.closest('#available-widgets').length){return}
var select2_args={ajax:{url:ajaxurl,dataType:'json',delay:250,type:'POST',data:function(params){return{q:params.term,page:params.page||1,action:$this.data('action'),nonce:automatorwp_admin_functions.nonce,table:$this.data('table'),option_none:$this.data('option-none'),option_none_value:$this.data('option-none-value'),option_none_label:$this.data('option-none-label'),}},processResults:automatorwp_select2_ajax_process_results},escapeMarkup:function(markup){return markup},templateResult:automatorwp_select2_ajax_template_result,theme:'default automatorwp-select2',placeholder:($this.data('placeholder')?$this.data('placeholder'):''),allowClear:!0,multiple:($this[0].hasAttribute('multiple'))};$this.automatorwp_select2(select2_args)}
