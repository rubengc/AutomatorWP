...
var automatorwp_original_automation_status='';var automatorwp_cancel_automation_run=!1;function automatorwp_run_automation(automation_id,users_per_loop){var $=$||jQuery;if(automatorwp_original_automation_status===''){automatorwp_original_automation_status=$('select#status').val();if(automatorwp_original_automation_status==='in-progress'){automatorwp_original_automation_status=$('.automatorwp-run-automation').data('original-status')}
...
if(response.data.run_again){automatorwp_run_automation(automation_id,users_per_loop)}else{$('.automatorwp-run-automation button .automatorwp-run-automation-running-label').hide();$('.automatorwp-run-automation button .automatorwp-run-automation-done-label').show();$('.automatorwp-cancel-automation-run').hide();setTimeout(function(){automatorwp_restore_run_automation_elements(response)},2000)}}else{automatorwp_restore_run_automation_elements(response)}},error:function(response){automatorwp_restore_run_automation_elements(response)}})}
